...
SPRITE_PATHS = {
    ...
    "messiah": BASE_DIR / "critter_sprites" / "messiah.png",
    "merfolk": BASE_DIR / "critter_sprites" / "merfolk.png",
    "merfolk_warrior": BASE_DIR / "critter_sprites" / "merfolk_warrior.png",
